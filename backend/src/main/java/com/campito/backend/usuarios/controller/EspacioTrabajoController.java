...
import com.campito.backend.usuarios.domain.dto.CompartirRequest;
...
import com.campito.backend.usuarios.domain.dto.ResponderSolicitudRequest;
...
@RestController
@RequestMapping("/api/espacios-trabajo")
...
public class EspacioTrabajoController {
    ...
    @ApiResponse(responseCode = "500", description = "Error interno del servidor")
    @PostMapping("/{idEspacioTrabajo}/miembros")
    public ResponseEntity<Void> compartirEspacioTrabajo(
            ...
            @Valid @RequestBody CompartirRequest request) {
        
        securityService.validateWorkspaceAdmin(idEspacioTrabajo);
        
        espacioTrabajoService.compartirEspacioTrabajo(request.email(), idEspacioTrabajo);
    ...
    public ResponseEntity<Void> responderSolicitudCompartirEspacioTrabajo(
        ...
        espacioTrabajoService.respuestaSolicitudCompartirEspacioTrabajo(idSolicitud, request.aceptada());
        return ResponseEntity.ok().build();
    }
    ...
    @ApiResponse(responseCode = "500", description = "Error interno del servidor")
    @GetMapping("/{idEspacioTrabajo}/miembros")
