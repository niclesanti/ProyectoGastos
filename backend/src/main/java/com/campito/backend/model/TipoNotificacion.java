...
public enum TipoNotificacion {
    ...
    /**
     * Notificación enviada cuando se cierra automáticamente un resumen de tarjeta
     * de crédito.
     */
    ...
    /**
     * Notificación enviada cuando un usuario es invitado a unirse a un espacio de
     * trabajo.
     */
    INVITACION_ESPACIO("Invitación a espacio de trabajo"),

    /**
     * Notificación enviada cuando se agrega un nuevo miembro a un espacio de
     * trabajo.
     */
    MIEMBRO_AGREGADO("Nuevo miembro agregado"),

    /**
     * Notificación enviada para recordar el próximo cierre de tarjeta.
     */
    RECORDATORIO_PROXIMO_CIERRE("Recordatorio de próximo cierre"),
