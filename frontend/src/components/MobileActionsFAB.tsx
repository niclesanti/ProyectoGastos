...
const actions = [
  ...
  },
  {
    ...
    description: 'Registrar transferencia entre cuentas',
    color: 'text-blue-500',
  },
  {
    id: 'credit',
    ...
    description: 'Registrar compra en cuotas',
    color: 'text-purple-500',
  },
  {
    id: 'payment',
    icon: Receipt,
    label: 'Resumen mensual tarjetas',
    description: 'Registrar pagos resúmenes tarjetas',
